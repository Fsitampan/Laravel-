...
class Borrowing extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::saving(function ($borrowing) {
            ...
            // Jika return_date kosong, gunakan borrow_date + end_time
            if (!$borrowing->planned_return_at && !$borrowing->return_date && $borrowing->borrow_date && $borrowing->end_time) {
                $borrowing->planned_return_at = Carbon::parse($borrowing->borrow_date)
                    ->setTimeFromTimeString($borrowing->end_time);
            }
        });
    }
    ...
    public function scopeCancelled($query) { return $query->where('status', BorrowingStatus::CANCELLED); }
    ...
    /**
     * ✅ Convert model ke array untuk Inertia.js
     */
    public function toInertiaArray(): array
    {
        return [
            ...
            'borrower_institution' => $this->borrower_institution,
            ...
            'layout_choice' => $this->layout_choice, // ✅ Layout yang dipilih
    ...
    /**
     * ✅ Auto refresh status berdasarkan waktu
     */
