...
import { Edit as EditIcon, ArrowLeft, Eye, EyeOff, Crown, Shield, User } from 'lucide-react';
...
export default function Edit({ user, roles, auth }: PageProps) {
    ...
    <AuthenticatedLayout
      header={
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-primary mb-1">Edit Pengguna</h2>
