...
export default function AuthenticatedLayout({
    ...
    const hasAccess = (item: NavigationItem) => {
        ...
        if (item.adminOnly && !['admin', 'super-admin'].includes(user.role)) return false;
        return true;
    };
                        ...
                        <div key={item.name} className="relative">
                            <Link
                                ...
                                className={cn(
                                    ...
                                    sidebarCollapsed && !mobile ? "px-3 py-3 justify-center" : "px-3 py-3",
                                    active
                            ...
                            >
                                <IconComponent className={cn(
                                    ...
                                    sidebarCollapsed && !mobile ? "h-5 w-5" : "mr-3 h-5 w-5",
                                    active 
                                        ? "text-blue-600" 
                                        : hasItemAccess 
                ...
                <div className="p-4 border-t border-gray-200 bg-gray-50/50">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        <div className="bg-white p-2 rounded border text-center">
                            ...
                            <div className="text-xs text-gray-600">Total Ruangan</div>
                        </div>
                        <div className="bg-white p-2 rounded border text-center">
                            <div className="text-lg font-semibold text-emerald-600">4</div>
    ...
    <DropdownMenuContent align="end" className="w-80 max-h-96 overflow-y-auto">
        ...
        {notifications && notifications.slice(0, 5).map((notification) => (
            <DropdownMenuItem
                key={notification.id}
                className={`flex items-start gap-2 py-2 px-2 rounded transition ${!notification.read_at ? "bg-blue-50" : ""}`}
                asChild
            >
                <Link href="/notifications">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className={`text-xs font-medium ${!notification.read_at ? "text-gray-900" : "text-gray-700"}`}>
                            {notification.title}
                        </div>
