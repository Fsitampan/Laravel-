...
// A simple utility to conditionally join class names, similar to `clsx` or `cn`
// This is provided so the component is self-contained.
// Added explicit type definition for the classes parameter.
const cn = (...classes: (string | boolean | undefined | null)[]) => classes.filter(Boolean).join(' ');

// All Select components are defined here.
// This is a common pattern for creating a custom component library.
  ...
  return (
    <div className="p-4 flex flex-col md:flex-row gap-4">
      ...
      <div className="text-sm">
        <p>Status yang dipilih: <strong>{status || "Tidak ada"}</strong></p>
        <p>Kategori yang dipilih: <strong>{category || "Tidak ada"}</strong></p>
      </div>
    </div>
  );
};
